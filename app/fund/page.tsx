...
export default async function FundPage() {
  ...
  return <main className="container"><nav className="nav"><Link className="brand" href="/">Superstrika#7046</Link><Link className="button secondary" href="/login">Team login</Link></nav>
    <header className="public-heading"><div><span className="eyebrow">Community support</span><h1>Team fund</h1></div><div className="team-stamp"><Image className="team-logo" src="/brand/superstrika.jpeg" alt="Superstrika 7046 RoboCup team logo" width={70} height={70} priority /><span>RoboCup Junior</span></div></header>
    <section className="fund-summary"><div className="balance-panel"><span className="eyebrow">Balance</span><div className="balance">{fmtIls(balance)}</div></div><div className="support-panel"><Link className="button" href="/#contact">To donate, please contact the team ↗</Link></div></section>
